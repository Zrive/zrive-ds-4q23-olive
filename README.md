# zrive-ds
Repositorio para el proyecto de predicción de etapa de maduracion de la oliva propuesto por Komorebi para el programa Zrive Applied Data Science (https://zriveapp.com/cursos/zrive-applied-data-science).
